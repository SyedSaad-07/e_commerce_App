...
export default class UpdateProductValidator {
  ...
  public schema = schema.create({
    product_name: schema.string.nullableAndOptional({},[rules.minLength(5),]),
    product_quantity: schema.string.nullableAndOptional({},[rules.minLength(50)]),
    details: schema.string.nullableAndOptional({},[rules.minLength(50)]),
    price: schema.number.nullableAndOptional(),
    seller_id: schema.string.nullableAndOptional(),
